 ...
 /*  return (
  ...
  return (
    <Popover className="relative bg-white">
      <div className="mx-auto max-w-24xl px-4 sm:px-6">
          ...
          <div className="divide-y-2 divide-gray-50 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
            ...
            <div className="space-y-6 py-6 px-5">
              ...
              <div>
                <a
                  href="#"
                  className="flex w-full items-center justify-center rounded-md border border-transparent bg-pink-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-pink-700"
                >
                  Sign up
                </a>
